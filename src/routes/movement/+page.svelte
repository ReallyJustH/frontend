...
<div class="flex flex-col justify-center w-full items-center p-4 h-screen">
    <div class="border border-black w-[300px] p-2 outer mb-2">
        <div>
            <div class=" box border border-black flex justify-center p-1" style="background-color:#205295 ;">
    ...
    <div class="border border-black w-[300px] p-2 outer flex flex-row justify-center items-center my-3">
        <div class="flex flex-row justify-evenly">
            <div class="flex flex-col items-center mr-2">
                <div class=" box border border-black flex justify-center p-1 w-fit px-10" style="background-color:#205295 ;">
    ...
    <div class="border border-black w-[300px] p-2 outer flex flex-col items-center my-3">
        <div class="flex flex-row justify-evenly">
            <div class="flex flex-col items-center mr-2">
                <div class=" box border border-black flex justify-center p-1 w-[130px]" style="background-color:#CC2C2C ;">
                    <h1 class="text-4xl text-white text-style">+5</h1>
                </div>
                <h1 class="text-4xl text-white text-style">Atk</h1>
            </div>
            <div class="flex flex-col items-center">
                <div class=" box border border-black flex justify-center p-1 w-[130px]" style="background-color:#39ADD1 ;">
        ...
        <div class="flex flex-row justify-evenly">
            <div class="flex flex-col items-center mr-2">
                <div class=" box border border-black flex justify-center p-1 w-[130px] " style="background-color:#FFB637 ;">
                    <h1 class="text-4xl text-white text-style">+4IN</h1>
                </div>
                <h1 class="text-4xl text-white text-style">Range</h1>
            </div>
            <div class="flex flex-col items-center">
                <div class=" box border border-black flex justify-center p-1 w-[130px] " style="background-color:#209525 ;">
